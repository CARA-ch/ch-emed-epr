 ...
 * These overriden invariants must start their expressions with "true and", otherwise they will not be applied by the validator (because the expression exists already).
*/

...
Instance: ObservationParacetamolAxapharmPrePadvChange
InstanceOf: CHEMEDEPRObservation
Title: "Observation: CHANGE of Axapharm paracetamol prescription, replaced with Dafalgan eff."
...
* extension[medicationRequestChanged].valueReference = Reference(urn:uuid:10bb1f25-f4f1-49cf-9123-9f235cf34c3f)
* identifier.system = "urn:ietf:rfc:3986"
...
Instance: ObservationParacetamolAxapharmPrePadvChangePml
InstanceOf: CHEMEDEPRObservationList
Title: "Observation: CHANGE of Axapharm paracetamol prescription, replaced with Dafalgan eff."
...
* extension[prescription].extension[externalDocumentId].valueIdentifier.value = "urn:uuid:e0c06f3c-1b63-468a-9c46-e800d39b6a15"
* extension[medicationRequestChanged].url = "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-medicationrequest-changed"
* extension[medicationRequestChanged].valueReference = Reference(urn:uuid:a62e5440-c82c-4270-92fb-d50cd515198a)
* extension[parentDocument].extension[id].valueIdentifier.system = "urn:ietf:rfc:3986"
...
* identifier.system = "urn:ietf:rfc:3986"
* identifier.value = "urn:uuid:383ed95d-95d3-4599-b975-9db806359c0d"
* status = #final
* code = urn:oid:1.3.6.1.4.1.19376.1.9.2.1#CHANGE
* subject.reference = "urn:uuid:9b00e81e-1165-4039-9d60-698ef838ae1a"
* issued = "2023-10-04T00:00:00+02:00"
...
* extension[medicationRequestChanged].url = "http://fhir.ch/ig/ch-emed/StructureDefinition/ch-emed-ext-medicationrequest-changed"
* extension[medicationRequestChanged].valueReference.reference = "urn:uuid:cc74c310-3e16-45ff-b03d-4e0787e552d3"
* identifier[+].system = "urn:ietf:rfc:3986"
